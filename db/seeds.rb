...
real_movies = [
  ['Solaris', 'Andrei Tarkovsky', 167, "A psychologist is sent to a station orbiting a distant planet in order to discover what has caused the crew to go insane.", 1972, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/solaris.jpg')))],
  ['Soy Cuba', 'Mikhail Kalazotov', 120, 'A movie about cuba', 1964, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/soy_cuba.jpg')))],
  ['Un chien andalou', 'Luis Bunuel', 16, "A surrealistic film with input from Salvador Dalí, director Luis Buñuel presents stark, surrealistic images that shock the viewers including the slitting open of a woman's eye and a dead horse being pulled along on top of a piano. Obviously open to interpretation - from deep meanings to it all meaning absolutely nothing - it is certain that this short (17 minutes) film presented something new in the cinema of its day.", 1929 , (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/unchienandalou.jpg'))) ],
  ...
  1998, (File.open(File.join(Rails.root,'./db/seed_photos/movie_posters/happiness.jpg'))) ],
  ['Picnic at Hanging Rock', 'Peter Weir', 115, "The film relates the fictitious story of the disappearance of several schoolgirls and their teacher during a picnic to Hanging Rock on St. Valentine's Day in 1900, and the subsequent effect on the local community. Picnic at Hanging Rock was a commercial and critical success.", 1975, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/picnic_at_hanging.jpg'))) ],
  ['7 Faces of Dr.Lao', 'George Pal', 100 , "A mysterious circus comes to a western town bearing wonders and characters that entertain the inhabitants and teach valuable lessons.", 1964, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/7.jpg')))],
  ['Boyz n the Hood', 'John Singleton', 112 , "Saga of a group of childhood friends growing up in a Los Angeles ghetto.", 1991, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/boyz.jpg')))],
  ['Nashville', 'Robert Altman', 159 , "Over the course of a few hectic days, numerous interrelated people prepare for a political convention as secrets and lies are surfaced and revealed.", 1975, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/nashville.jpg')))],
  ['The Lost Skeleton of Cadavra', 'Larry Blamire', 90 , "A bad scientist and wife, a mad scientist and skeleton, two aliens and their escaped pet are all searching for the elusive element \"atmospherium\".", 2001, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/lost.jpg')))],
  ['Panther Panchali', 'Satyajit Ray', 122 , "The story of a young boy, Apu, and life in his small Indian village. His parents are quite poor - his father Harihar, a writer and poet, gave away the family's fruit orchard to settle his brother's debts. His sister Durga and an old aunt also still lives with them. His mother Sarbojaya bears the brunt of the family's situation. She scrapes by and sells her personal possessions to put food on the table and has to bear the taunts of her neighbors as Durga is always stealing fruit from their orchard. Things get worse when Harihar disappears for five months and Durga falls ill. Even after Harihar returns, the family is left with few alternatives.", 1955, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/panther.jpg')))],
  ['I Even Met Happy Gypsies', 'Aleksandar Petrovic', 94 , "Bora the Gypsy is married to an older woman, and he falls in love with the younger Tissa, who is being offered in marriage by her father, to a young gypsy man. This marriage arrangement is according to custom. Tissa rejects her husband, claiming he is not able to consumate the marriage, and Bora joins her. They get a monk in the mountains to marry them. Unable to return to the Gypsy camp, Tissa tries to reach Belgrad on her own, but a couple of truck drivers rape her, and she does return in misery to her tribe. Meanwhile, Bora defends his honour the traditional way, in a knife duwl, and kills his opponent. Therefore he, too, must leave the tribe. And yet, we'll find happy gypsies...", 1967, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/gypsy.jpg')))],
  ['La Jetée', 'Chris Marker', 28 , "Time travel, still images, a past, present and future and the aftermath of World War III. The tale of a man, a slave, sent back and forth, in and out of time, to find a solution to the world's fate. To replenish its decreasing stocks of food, medicine and energies, and in doing so, resulting in a perpetual memory of a lone female, life, death and past events that are recreated on an airports jetée.", 1962, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/jetee.jpg')))],
  ['The Marriage of Maria Braun', 'Rainer Werner Fassbinder', 120, "A World War II widow seeks to adjust to life in postwar Germany.", 1979, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/marriage.jpg')))],
  ['Cinema Paradiso', 'Guiseppe Tornatore', 155 , "A filmmaker recalls his childhood, when he fell in love with the movies at his village's theater and formed a deep friendship with the theater's projectionist.", 1988, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/cinema.jpg')))],
  ['Touch of Evil', 'Orson Welles', 95 , "A stark, perverse story of murder, kidnapping, and police corruption in a Mexican border town.", 1958, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/touch.jpg')))],
  ['Le Beau Serge', 'Claude Chabrole', 98 , "Francois comes back to his home village in France after more than a decade. He notices that the village hasn't changed much, but the people have, especially his old friend Serge who has become a drunkard. Francois now tries to find out what happened to him and tries to help him.", 1958, (File.open(File.join(Rails.root, './db/seed_photos/movie_posters/beau.jpg')))]
]
